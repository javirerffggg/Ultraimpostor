...
import { MousePointer2, ChevronUp, Hand, Smartphone, Eye, Turtle, PersonStanding, Zap } from 'lucide-react';
import { ThemeConfig, GameState } from '../../types';
import {
    SectionContainer, SectionHeader, ContentCard,
    SettingRow, PremiumToggle, IconSegmentedControl
...
const SPEED_ICONS = {
    low: <Turtle size={16} />,
    medium: <PersonStanding size={16} />,
    high: <Zap size={16} />
};

export const RevealMethodSection: React.FC<Props> = ({ gameState, theme, onUpdateSettings, searchQuery = '' }) => {
    if (searchQuery && !'revelacion cartas hold swipe sensibilidad velocidad pulsar deslizar consulta de rol re-reveal'.includes(searchQuery.toLowerCase())) return null;
